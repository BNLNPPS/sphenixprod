...
def main():
    ...
    # This is now done in the RuleConfig class yaml reader
    # command line arguments to override the yaml file are passed to the ctor
    ## TODO dbinput, mem, docstring, unblock, batch_name
    
    #################### Load specific rule from the given yaml file.
    try:
        all_rules = RuleConfig.from_yaml_file(args)
