...
def submission_args():
    ...
    parser.add_argument('--check-legacy', action=argparse.BooleanOptionalAction, default=False,
                        help="Check the legacy production_status table (default: False)")
    ...
    parser.add_argument('--maxjobs', dest="maxjobs", help="Maximum number of jobs to create in one pass", default=0, type=int)
