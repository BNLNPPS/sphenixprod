...
CREATE TABLE IF NOT EXISTS production_run_reports (
    ...
    source_data_as_of               TIMESTAMP WITH TIME ZONE,
...
COMMENT ON COLUMN production_run_reports.source_data_as_of IS 'Optional watermark for the source DB state summarized by this report, if a reliable source timestamp is available.';
